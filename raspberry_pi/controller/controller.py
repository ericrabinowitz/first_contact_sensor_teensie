...
FADE_MS = 5000  # Fade time in milliseconds
COOL_DOWN_MS = 30000  # Audio recent song wait time in milliseconds

# MQTT server settings
MQTT_BROKER = "127.0.0.1"  # IP address of your MQTT broker
MQTT_PORT = 1883  # Default MQTT port
MQTT_TOPIC = "missing_link/control"  # Topic that the Teensy with send and receive msgs on
...
def initializeWled():
    ...
    for effect in Effect:
        try:
            ...
            print(f"Effect {effect.name} not found in WLED effects list.")
